...
export const PlaylistThumbnail =({
    ...
    return(
        <div className={cn(
           ...
           <div className="absolute bottom-2 right-2 px-1 py-0.5 rounded bg-black/80 text-white twxt-xs font-medium flex items-center gap-x-1">
