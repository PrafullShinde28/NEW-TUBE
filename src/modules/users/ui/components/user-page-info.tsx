    ...
    return(
        <div className="py-6">
            ...
            <div className="flex flex-col md:hidden">
                <div className="flex item-center gap-y-3">
            ...
            <div className="flex flex-col md:hidden">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex item-center gap-1 text-xs text-muted-foreground mt-1">
                            <span>{user.subscriberCount} subscriber</span>
                            <span>&bull;</span>
                 ...
                 <UserAvatar
                    ...
                    />
                     <div className="flex-1 min-w-0">
                        ...
                        <div className="flex item-center gap-1 text-xs text-muted-foreground mt-3">
                            <span>{user.subscriberCount} subscriber</span>
                            <span>&bull;</span>
                            <span>{user.videoCount} videos</span>
